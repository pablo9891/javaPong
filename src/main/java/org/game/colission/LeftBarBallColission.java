...
public class LeftBarBallColission extends BarBallColission {
...
/*
        ...
        System.out.println("BALL LEFT: " + ballLeft);
        System.out.println("DELTA: " + delta);
        System.out.println("BALL DIRECTION: " + ball.getDirection().getX());
        System.out.println("EVALUATION: " + (ballLeft <= barRight &&
                barLeft <= ballLeft &&
                barTop <= ballTop &&
                ballTop <= barBottom &&
                barTop <= ballBottom &&
